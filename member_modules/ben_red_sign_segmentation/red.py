...
MODULE_OWNER = "Ben"
MODULE_TITLE = "Red sign segmentation using color information"
COLOR_NAME = "red"


def segment_red_signs(hsv_image: UInt8Image, color_settings: Mapping[str, Any]) -> UInt8Image:
    """Create the red traffic-sign mask from configured HSV red ranges."""
