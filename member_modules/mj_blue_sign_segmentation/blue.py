...
MODULE_OWNER = "MJ"
MODULE_TITLE = "Blue sign segmentation using color information"
COLOR_NAME = "blue"


def segment_blue_signs(hsv_image: UInt8Image, color_settings: Mapping[str, Any]) -> UInt8Image:
    """Create the blue traffic-sign mask from configured HSV blue ranges."""
